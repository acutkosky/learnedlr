...
def optax_learned_lr_init(
    ...
    state = {
        ...
        'prev_scaling': jnp.zeros(1),
        'clip': clip,
        'ol_state':  ol_init(jnp.zeros(1), *ol_args, **ol_kwargs), #ol_state, #ol_init(jnp.zeros(1), *ol_args, **ol_kwargs),
    }
    return state, functools.partial(optax_learned_lr_update, multiply, additive_bounds, optax_opt, ol_update_fn)
...
def optax_learned_lr_update(
    ...
    returns:
        rng: next value for JAX rng
        value: loss value from loss_and_grad_fn
    ...
    if multiply:
        ...
        if additive_bounds:
            residual = jnp.clip(ol_state['prediction'], a_min=lower_bound, a_max=upper_bound)
        else:
...
# PyTreeDef(({'bet_fractions': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'bet_grad_squared_sum': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'decay': *, 'eps': *, 'eta': *, 'grad_sum': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'max_grads': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'prediction': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'wealth': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}}, *, *))
# PyTreeDef(({'bet_fractions': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'bet_grad_squared_sum': ({'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}},), 'decay': *, 'eps': *, 'eta': *, 'grad_sum': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'max_grads': ({'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}},), 'prediction': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}, 'wealth': {'features': [], 'head': {'bias': *, 'weight': *}, 'pos_embeddings': *, 'tok_embeddings': {'weight': *}}}, *, *))
